...
class UtilitiesTabState extends State<UtilitiesTab> {
  ...
  void addOrEditCategory({CategoryItem? item, required bool isExpense}) {
    ...
    IconData selectedIcon = item != null
        ...
        return Card(
          ...
          child: ListTile(
            leading: CircleAvatar(
              backgroundColor: Color(item.colorValue).withValues(alpha: 0.2),
              child: Icon(
                IconData(item.iconCode, fontFamily: 'MaterialIcons'),
            ...
            trailing: Row(
              ...
              children: [
                ...
                IconButton(
                  ...
                  onPressed: () =>
                      addOrEditCategory(item: item, isExpense: item.isExpense),
                ),
                IconButton(
                  icon: const Icon(Icons.delete, color: Colors.red),
                  onPressed: () => _deleteConfirm(item.id),
                ),
              ],
            ),
          ),
