      ...
      builder: (context, catSnapshot) {
        ...
        return StreamBuilder<QuerySnapshot>(
          ...
          builder: (context, txSnapshot) {
            ...
            final allTransactions = txSnapshot.data!.docs
                .map(
                  (doc) => Transaction.fromMap(
                    doc.data() as Map<String, dynamic>,
                    doc.id,
                  ),
                )
            ...
            return Column(
              children: [
                TableCalendar(
                  ...
                  onHeaderTapped: (_) => showMonthYearPicker(context),
                  ...
                  eventLoader: (day) => allTransactions
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: TextStyle(
                              fontWeight: FontWeight.bold,
                              fontSize: 16,
                              color: dailyTotal >= 0 ? Colors.blue : Colors.red,
                            ),
                          ),
                        ],
                      ),
